...
namespace UnityEngine.UI.Extensions
{
    ...
    {
        protected Rect panelDimensions;
		protected RectTransform _screensContainer;
		protected bool _isVertical;

		protected int _screens = 1;

		protected float _scrollStartPosition;
		protected float _childSize;
        private float _childPos, _maskSize;
		protected Vector2 _childAnchorPoint;
		public ScrollRect _scroll_rect;
		protected Vector3 _lerp_target;
		protected bool _lerp;
		protected bool _pointerDown = false;
		protected bool _settled = true;
		protected Vector3 _startPosition = new Vector3();
        [Tooltip("The currently active page")]
		protected int _currentPage;
		protected int _previousPage;
		protected int _halfNoVisibleItems;
		protected bool _moveStarted;
